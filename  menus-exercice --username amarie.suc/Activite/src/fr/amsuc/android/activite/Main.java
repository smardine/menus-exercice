...
public class Main extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.getIntent().getExtras() != null){
        	...
        	Log.i("sous activite", "OnCreate récupere "+s);
        	edit.setText(s);
        }
        this.setResult(2000);
    }
	...
	public void onClick(View arg0) {
		// ici on peut pousser une nouvelle activité grace aux Intent
		
		//création d'une instance de Main2:
		Intent intent = new Intent(this, Main2.class); 
		intent.putExtra("madonnee", "J'envoi Bonjour! depuis activite main");
		
		// pour démarrer cette nouvelle instance:
		this.startActivityForResult(intent, 1000); 
		//??le requestcode (2eme arg) est un paramètre qu'on veut envoyer à son sous-actvité ??
	}
	
	@Override
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		//sert à récupérer un éventuel resultcode émis par l'activité
		//que cette activité à lancer
