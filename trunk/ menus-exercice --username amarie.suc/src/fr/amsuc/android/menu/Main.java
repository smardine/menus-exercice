...
public class Main extends Activity implements OnLongClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //créer un écouteur de long clic
        view.setOnLongClickListener(this);
        //créer un écouteur pour la création du menu contextuel
        view.setOnCreateContextMenuListener(this);
        // comme les écouteurs sont affectés à la vue ça signifie qu'il
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
    	// C'est ici qu'on change les propriétés du menu 
    	// lorsque le menu s'ouvre. On peut donc ckecker ou pas un item
    	menu.findItem(2000).setTitle(""+SystemClock.elapsedRealtime());
    	// dans une activité nécessitant une authentifiction l'entrée
    	// connexion peut disparaître si l'utilisateur est loggé.
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
    	...
    	// créer "à la volée" le menu contextuel parce que le long clic
    ...
    public boolean onContextItemSelected(MenuItem item) {
    	// ici réagir lors du choix d'un item du menu contextuel
    	switch(item.getItemId()) {
    	// l'identifiant integer est moins gourmand en ressource que le string
    	case 1000: 
